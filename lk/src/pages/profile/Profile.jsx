...
// ─────────────────────────────────────────────────────────────────────
// ОТКЛЮЧЕНО 31.07.2026 по просьбе клиента: раздел «Дети» (и «Родители
// и близкие» на той же вкладке) временно скрыт. Код НЕ удалён — чтобы
// вернуть раздел, достаточно поставить здесь true и раскомментировать
// пункт «Дети» в src/config/navigation.jsx.
//
// Флагом, а не блочным комментарием: внутри разметки уже есть свои
// JSX-комментарии, а вложенные /* */ обрывают друг друга и ломают сборку.
// ─────────────────────────────────────────────────────────────────────
const SHOW_KIDS_SECTION = false;
