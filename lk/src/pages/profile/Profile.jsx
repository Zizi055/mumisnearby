...
// Блок «Родители и близкие» на той же вкладке остаётся рабочим — там
// можно добавить второго родителя. Код детей НЕ удалён: чтобы вернуть
// раздел, поставь здесь true.
//
