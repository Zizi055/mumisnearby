...
const categoryMeta = {
  ...
  poems: {
    type: 'poem',
    title: 'Стихи',
    count: 'Стихи для чтения вслух',
    description: 'Короткие добрые стихи — на пару минут перед сном.',
  },

  // Слаг 'stories' уже занят сказками (fairy_tale), поэтому рассказы
  // живут на /library/short-stories.
  'short-stories': {
    type: 'story',
    title: 'Рассказы',
    count: 'Рассказы для детей',
    description: 'Небольшие истории с сюжетом — для чтения и обсуждения.',
  },
};
