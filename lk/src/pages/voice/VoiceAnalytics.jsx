  ...
  return (
    <section className="lk-voice-analytics">
      ...
      <div className="lk-voice-analytics__stats">
        ...
        {/* Было «Уникальные дети» — формулировка из корпоративной
            веб-аналитики, к тому же в семейном кабинете считать детей
            «уникальными посетителями» странно. */}
        <AnalyticsCard
          icon={<AudioLines size={18} />}
          title="Сценариев прослушано"
          value="86"
          growth="+9%"
        />
      </div>
