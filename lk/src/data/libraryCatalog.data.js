...
export const LIBRARY_ITEMS = [
  {
    ...
    description: 'Тихая сказка о дружбе, доме и мягком вечернем свете. Маленькая совушка помогает малышу не бояться темноты и найти покой в тёплой ночи.',
    duration: 7,
    age: '3-6',
  ...
  },
  {
    ...
    type: LIBRARY_CONTENT_TYPES.FAIRY_TALE,
    title: 'В мире сказки',
    description: 'Тёплая история о маленьком путешествии и добром выборе. Мальчик открывает для себя удивительный мир, где каждое решение имеет значение.',
    duration: 12,
    age: '0-2',
  ...
  },
  {
    ...
    title: 'Сонный лес',
    description: 'Медленный сценарий для засыпания с мягкими паузами. Голос рассказчика ведёт ребёнка через сонный лес, где всё замирает на ночь.',
    duration: 9,
    age: '0-2',
  ...
  },
  {
    ...
    title: 'Я рядом',
    description: 'Поддерживающий сценарий для тревожного состояния. Бережные слова помогают ребёнку почувствовать безопасность и уверенность в себе.',
    duration: 14,
    age: '7-10',
  ...
  },
  {
    ...
    description: 'Личная семейная история для сохранения родного голоса. Тёплые воспоминания о доме, которые останутся с ребёнком навсегда.',
    duration: 11,
    age: '10+',
  ...
  },
  {
    id: 6,
    type: LIBRARY_CONTENT_TYPES.FAIRY_TALE,
    title: 'Иванушка и Жар-птица',
    description: 'Русская народная сказка о смекалке и смелости. Иванушка отправляется в путь за Жар-птицей и встречает добрых помощников на своём пути.',
    duration: 15,
    age: '3-6',
    emotions: ['bravery', 'joy', 'happiness'],
  ...
  },
  {
    ...
    type: LIBRARY_CONTENT_TYPES.FAIRY_TALE,
    title: 'Морозко',
    description: 'Добрая русская народная сказка о трудолюбии и доброте. Падчерица встречает волшебного Морозко, который щедро награждает добрых и скромных.',
    duration: 18,
    age: '3-6',
    emotions: ['warmth', 'happiness', 'coziness'],
    themes: ['family'],
    image: `${import.meta.env.BASE_URL}img/story.png`,
    isFavorite: false,
    isPremium: false,
  ...
  },
  {
    ...
    description: 'Известная русская народная сказка о верности и любви. Иван-царевич отправляется искать свою невесту и открывает удивительный тайный мир.',
    duration: 20,
    age: '7-10',
    emotions: ['bravery', 'joy', 'warmth'],
    themes: ['friendship', 'family'],
    image: `${import.meta.env.BASE_URL}img/story2.png`,
    isFavorite: false,
    isPremium: false,
